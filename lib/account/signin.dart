...
class Signin extends StatefulWidget {
  ...
  @override
  _SigninState createState() => new _SigninState(scaffoldKey: scaffoldKey);
}

class _SigninState extends State<Signin> with SingleTickerProviderStateMixin {
  final FocusNode myFocusNodeEmailSignin = FocusNode();
  final FocusNode myFocusNodePasswordSignin = FocusNode();
  ...
  _SigninState({this.scaffoldKey}) : super();
  GlobalKey<ScaffoldState> scaffoldKey;
